...
class HowDoYouFeelViewState extends State<HowDoYouFeelView> {
  ...
  late HowDoYouFeelViewModel howDoYouFeelViewModel;
    ...
    if (mounted) {
      Navigator.push(
        ...
        PageRouteBuilder(
          ...
          pageBuilder:
              (_, __, ___) => AIAnswerView(
                question: textController.text,
                replyAI: howDoYouFeelViewModel.replyAI,
              ),
        ),
      );
    }
  ...
  Future<void> _post() async {
    await howDoYouFeelViewModel.post(textController.text);

    if (howDoYouFeelViewModel.replyAI.reply.isNotEmpty) {
      nextScreen();
    }
  }
  ...
  void didChangeDependencies() {
    ...
    howDoYouFeelViewModel = Provider.of<HowDoYouFeelViewModel>(context);
  }
